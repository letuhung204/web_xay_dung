                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="margin-left: 5px;width: 40%;float: left;">
                                                <spring:url
                                                        value="/menu/${duan.idDuAn}/edit" var="editURL" />
                                                <a href="${editURL}" style="font-size: 25px;"><i
                                                        class="glyphicon glyphicon-pencil"></i></a>
                                            </div>
                                            <div style="width: 40%;float: left">
                                            <spring:url value="/menu/delete/${duan.idDuAn}" var="deleteURL" /> <a href="${deleteURL}" style="font-size: 25px;"
                                                                      onclick="return confirm('Bạn chắc chắn xoá menu có tên : ${duan.name} ?');"><i
